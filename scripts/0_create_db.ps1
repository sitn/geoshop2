...
psql -U $env:PGUSER -d $env:PGDATABASE -c "CREATE SCHEMA dangersnaturels AUTHORIZATION geoshop;"
psql -U $env:PGUSER -d $env:PGDATABASE -c "CREATE SCHEMA environnement AUTHORIZATION geoshop;"
psql -U $env:PGUSER -d $env:PGDATABASE -c "CREATE SCHEMA defense_incendie AUTHORIZATION geoshop;"
