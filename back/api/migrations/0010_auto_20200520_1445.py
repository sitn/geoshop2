    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unit_price', djmoney.models.fields.MoneyField(decimal_places=2, default_currency='CHF', max_digits=14, verbose_name='price')),
                ('geom', django.contrib.gis.db.models.fields.MultiPolygonField(srid=2056, verbose_name='geom')),
            ],
            options={
                'verbose_name': 'pricing_layer',
        ...
        migrations.AddField(
            model_name='pricing',
            name='max_price',
            field=djmoney.models.fields.MoneyField(decimal_places=2, default_currency='CHF', max_digits=14, null=True, verbose_name='max_price'),
        ),
        migrations.AddField(
            model_name='pricing',
            name='min_price',
            field=djmoney.models.fields.MoneyField(decimal_places=2, default_currency='CHF', max_digits=14, null=True, verbose_name='min_price'),
        ),
        migrations.AddField(
            model_name='pricing',
        ...
        migrations.AddField(
            model_name='pricing',
            name='pricing_type',
            field=models.CharField(choices=[('FREE', 'Free'), ('SINGLE', 'Single'), ('BY_AREA', 'By area'), ('FROM_PRICING_LAYER', 'From a pricing layer'), ('MANUAL', 'Manual')], default='FREE', max_length=30, verbose_name='pricing_type'),
            preserve_default=False,
        ),
        migrations.AddField(
            model_name='pricing',
            name='unit_price',
            field=djmoney.models.fields.MoneyField(decimal_places=2, default_currency='CHF', max_digits=14, null=True, verbose_name='unit_price'),
        ),
        migrations.AddField(
            model_name='pricing',
        ...
        migrations.AddField(
            model_name='product',
            name='pricing',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='api.Pricing', verbose_name='pricing'),
        ),
        ...
        migrations.AlterField(
            ...
            name='order',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='items', to='api.Order', verbose_name='order'),
        ),
